...
namespace Havoc
{
    public class Test_Level : Level
    {
        public override void LoadContent()
        {
            ...
            backGroundImages[0].Position.X = (ScreenManager.Instance.Dimensions.X / 2) - (backGroundImages[0].Texture.Width / 2);
            backGroundImages[0].Position.Y = (ScreenManager.Instance.Dimensions.Y / 2) - (backGroundImages[0].Texture.Height / 2);
            ...
            backGroundImages[1].Position.X = (ScreenManager.Instance.Dimensions.X / 2) - (backGroundImages[1].Texture.Width / 2);
            backGroundImages[1].Position.Y = 200;

            // Set mountains in correct location
            backGroundImages[2].Position.X = (ScreenManager.Instance.Dimensions.X / 2) - (backGroundImages[2].Texture.Width / 2);
            backGroundImages[2].Position.Y = 300;

            // Set platform in correct location
            platforms[0].Image.Position.X = ScreenManager.Instance.Dimensions.X / 2 - (platforms[0].Image.SourceRect.Width / 2);
            platforms[0].Image.Position.Y = ScreenManager.Instance.Dimensions.Y - 450;
